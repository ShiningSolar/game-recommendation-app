...
def detail_selected_game(title, genres, tanggal, website, movies, list_media, about, review, developer, publisher, header_img):
...
def view(game_name):
    ...
    data, title, genres, tanggal, website, movies, list_media, about, review, developer, publisher, header_img = get_recommendation_data(game_name)
    # Menampilkan header
    st.header("Detail Game")
    # Memanggil fungsi detail_selected_game untuk menampilkan detail game
    detail_selected_game(title, genres, tanggal, website, movies, list_media, about, review, developer, publisher, header_img)
    # # Menampilkan header
